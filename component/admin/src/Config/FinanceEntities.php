    ...
    public static function definitions(): array
    {
        return [
            'dues'=>['table'=>'#__decaromembership_dues','label'=>'COM_DECAROMEMBERSHIP_DUES','singular'=>'COM_DECAROMEMBERSHIP_DUE','title_field'=>'association_year','search'=>['association_year','status','reference'],'list'=>['member_id','association_year','amount','paid_amount','status','due_date','reference'],'fields'=>[
                ...
                'status'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_DUE_STATUS','type'=>'select','required'=>true,'default'=>'unpaid','options'=>['unpaid'=>'COM_DECAROMEMBERSHIP_PAYMENT_UNPAID','partial'=>'COM_DECAROMEMBERSHIP_PAYMENT_PARTIAL','paid'=>'COM_DECAROMEMBERSHIP_PAYMENT_PAID','waived'=>'COM_DECAROMEMBERSHIP_PAYMENT_WAIVED']],
