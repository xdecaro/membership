    ...
    public static function definitions(): array
    {
        return [
            'members'=>['table'=>'#__decaromembership_members','label'=>'COM_DECAROMEMBERSHIP_MEMBERS','singular'=>'COM_DECAROMEMBERSHIP_MEMBER','title_field'=>'last_name','search'=>['first_name','last_name','tax_code','member_number','card_number','email'],'list'=>['member_number','last_name','first_name','category_id','location_id','status','card_number','email'],'fields'=>[
                ...
                'current_period_started_on'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_CURRENT_PERIOD_STARTED','type'=>'date'],
                'ended_on'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_ENDED_ON','type'=>'date'],
                'status_reason'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_STATUS_REASON','type'=>'text'],
                'rights_status'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_RIGHTS_STATUS','type'=>'select','default'=>'normal','options'=>['normal'=>'COM_DECAROMEMBERSHIP_RIGHTS_NORMAL','suspended'=>'COM_DECAROMEMBERSHIP_RIGHTS_SUSPENDED','none'=>'COM_DECAROMEMBERSHIP_RIGHTS_NONE']],
                'can_vote_override'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_CAN_VOTE_OVERRIDE','type'=>'select','options'=>['1'=>'JYES','0'=>'JNO']],
                'can_candidate_override'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_CAN_CANDIDATE_OVERRIDE','type'=>'select','options'=>['1'=>'JYES','0'=>'JNO']],
