    ...
    public static function definitions(): array
    {
        return [
            ...
            'cards'=>['table'=>'#__decaromembership_cards','label'=>'COM_DECAROMEMBERSHIP_CARDS','singular'=>'COM_DECAROMEMBERSHIP_CARD','title_field'=>'card_number','search'=>['card_number','type','status'],'list'=>['card_number','member_id','type','status','issued_at','activated_at','expires_at','annual_mark'],'fields'=>[
                ...
                'type'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_CARD_TYPE','type'=>'select','required'=>true,'options'=>['physical'=>'COM_DECAROMEMBERSHIP_CARD_PHYSICAL','electronic'=>'COM_DECAROMEMBERSHIP_CARD_ELECTRONIC']],
                'status'=>['label'=>'COM_DECAROMEMBERSHIP_FIELD_CARD_STATUS','type'=>'select','required'=>true,'options'=>['pending'=>'COM_DECAROMEMBERSHIP_CARD_STATUS_PENDING','active'=>'COM_DECAROMEMBERSHIP_CARD_STATUS_ACTIVE','expired'=>'COM_DECAROMEMBERSHIP_CARD_STATUS_EXPIRED','lost'=>'COM_DECAROMEMBERSHIP_CARD_STATUS_LOST','revoked'=>'COM_DECAROMEMBERSHIP_CARD_STATUS_REVOKED','replaced'=>'COM_DECAROMEMBERSHIP_CARD_STATUS_REPLACED']],
